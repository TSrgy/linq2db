...
namespace LinqToDB.Data
{
	...
	public partial class DataConnection : ICloneable
	{
		...
		/// </summary>
		internal IDbCommand? CurrentCommand => _command;

		/// <summary>
		/// Creates if needed and returns current command instance.
		/// </summary>
		internal IDbCommand GetOrCreateCommand() => _command ??= CreateCommand();
		...
		[Obsolete("Command property is obsoleted and will be removed in future. " +
			" If you receive this warning from code, generated by T4 templates - regenerate your model." +
			" If you used this property to access command SQL - use LastQuery property." +
			" If you used this property to access command parameters - use LastParameters property." +
			" If you used this property to configure command object before execution - use DbCommandProcessorExtensions.Instance extension point or OnCommandInitialized event")]
